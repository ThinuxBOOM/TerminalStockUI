...
function ScreenerPage() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "mb-3 text-sm tracking-widest text-term-muted" }, "SCREENER \xB7 RANKED BY FORECAST DIRECTION"), /* @__PURE__ */ React.createElement("section", { className: "term-panel p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-end gap-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "term-label", htmlFor: "screener-market" }, "Market"), /* @__PURE__ */ React.createElement(
  ...
  ) : /* @__PURE__ */ React.createElement("div", { className: "term-panel-hero overflow-x-auto" }, /* @__PURE__ */ React.createElement("table", { className: "w-full text-sm" }, /* @__PURE__ */ React.createElement("caption", { className: "sr-only" }, "Screener results ranked by forecast direction"), /* @__PURE__ */ React.createElement("thead", { className: "sticky top-0 bg-term-panel z-10" }, /* @__PURE__ */ React.createElement("tr", { className: "border-b border-term-border text-left text-xs text-term-muted" }, /* @__PURE__ */ React.createElement("th", { scope: "col", className: "p-2" }, "#"), /* @__PURE__ */ React.createElement("th", { scope: "col", className: "p-2" }, "Symbol"), /* @__PURE__ */ React.createElement("th", { scope: "col", className: "p-2 text-right" }, "Price"), /* @__PURE__ */ React.createElement("th", { scope: "col", className: "p-2 text-right" }, "Prob ", horizon, "d"), /* @__PURE__ */ React.createElement("th", { scope: "col", className: "p-2" }, "Confidence"), /* @__PURE__ */ React.createElement("th", { scope: "col", className: "p-2" }, "Quality"), /* @__PURE__ */ React.createElement("th", { scope: "col", className: "p-2" }, "Market"), /* @__PURE__ */ React.createElement("th", { scope: "col", className: "p-2" }, "Provenance"))), /* @__PURE__ */ React.createElement("tbody", null, rows.map((r, idx) => /* @__PURE__ */ React.createElement("tr", { key: `${r.symbol}-${r.exchange_mic}-${idx}`, className: "border-b border-term-border even:bg-term-panel2 transition-colors duration-150" }, /* @__PURE__ */ React.createElement("td", { className: "p-2 text-term-muted" }, (data.offset ?? offset) + idx + 1), /* @__PURE__ */ React.createElement("td", { className: "p-2" }, /* @__PURE__ */ React.createElement(
    Link,
    {
    ...
    r.symbol
  ), /* @__PURE__ */ React.createElement("span", { className: "ml-2 text-xs text-term-muted" }, r.company_name, r.exchange_mic ? ` \xB7 ${r.exchange_mic}` : "")), /* @__PURE__ */ React.createElement("td", { className: "p-2 text-right term-num" }, /* @__PURE__ */ React.createElement(CurrencyValue, { value: r.price, currency: r.currency })), /* @__PURE__ */ React.createElement("td", { className: "p-2 text-right term-num" }, /* @__PURE__ */ React.createElement("b", null, Number.isFinite(r.direction_probability) ? `${(r.direction_probability * 100).toFixed(1)}%` : "\u2014")), /* @__PURE__ */ React.createElement("td", { className: "p-2 text-xs" }, r.confidence), /* @__PURE__ */ React.createElement(
    "td",
    {
