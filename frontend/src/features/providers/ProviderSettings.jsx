...
function ProviderSettings() {
  ...
  const health = useQuery({ queryKey: ["health"], queryFn: ({ signal }) => getHealth({ signal }), retry: false, staleTime: 30000 });
