...
// Cap candles pushed to lightweight-charts: 250-bar payloads downsampled
// every-Nth (visual fidelity identical, setData ~2x faster). Last bar
// always kept so the close tracks the header quote.
const MAX_CHART_CANDLES = 150;
function downsampleCandles(candles) {
